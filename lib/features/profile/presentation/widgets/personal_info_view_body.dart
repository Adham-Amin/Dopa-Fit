      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12.h),
            PersonalInfoItem(labal: 'Age', value: user.age.toString()),
            SizedBox(height: 12.h),
            PersonalInfoItem(labal: 'Gender', value: user.gender.toString()),
            SizedBox(height: 12.h),
            PersonalInfoItem(labal: 'Activity Level', value: user.activityLevel!),
            SizedBox(height: 12.h),
            PersonalInfoItem(labal: 'Goal', value: '${user.goal} kcal'),
            SizedBox(height: 12.h),
            PersonalInfoItem(
              labal: 'Workout Split',
